"""
Django settings for hidden_star_42264 project.
...
ROOT_URLCONF = 'hidden_star_42264.urls'
...
WSGI_APPLICATION = 'hidden_star_42264.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_star_42264 API",
    "DESCRIPTION": "API documentation for hidden_star_42264 App",
    "VERSION": "v1",
}
